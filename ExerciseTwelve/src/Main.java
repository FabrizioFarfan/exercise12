...
public class Main {
     ...
     * <p>
     * The printout the first remaining item
     */
    ...
    public static void exercise2() {
        ...
        menuItems.add("Normal Hamburger");
        menuItems.add("Double Hamburger");
        menuItems.add("Super Hamburger Extra-cheese");
        menuPrices.add(3.89);
        menuPrices.add(6.89);
        menuPrices.add(8.89);
        System.out.println(menuItems.get(0) + " price is: " + menuPrices.get(0));
        System.out.println(menuItems.get(1) + " price is: " + menuPrices.get(1));
        System.out.println(menuItems.get(2) + " price is: " + menuPrices.get(2));
